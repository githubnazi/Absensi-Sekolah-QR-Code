                        ...
                        <div class="card-body my-auto px-5">
                            ...
                            <form id="scanForm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="uniqueCodeInput" name="unique_code"
                                        required>
                                </div>
                ...
                <div class="mx-auto" style="max-width: 25vw;">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="pl-3">
                                <li>Jika berhasil scan maka akan muncul data siswa/guru dibawah preview
                                    kamera</li>
...
<script type="text/javascript">
            ...
            .then(videoInputDevices => {
                ...
                if (videoInputDevices.length < 1) {
                    // alert("Camera not found!");
                     $('#errorMessage').text("Camera not found!").show();
                    return;
                }
    ...
    if (navigator.mediaDevices) {
      ...
      $('#errorMessage').text("Cannot access camera.").show();
    }
    ...
    $('#scanForm').submit(function (e) {
        e.preventDefault();
        const uniqueCode = $('#uniqueCodeInput').val();
        if (uniqueCode) {
            cekData(uniqueCode);
            $('#uniqueCodeInput').val('');
        }
    ...
    // Put cursor in unique code form input
